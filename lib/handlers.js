...
handlers._tokens.post = (data, callback) => {
    ...
    if(phone && password) {
        ...
        callback(helpers.errors('missingFields'));
    }
};
...
// required data: phone, password
// optional data: none
// TODO: only get if authenticated user and for that user only
...
//                     callback(200, )
//                 } else {
//                     callback(400, {'Error': 'Incorrect password. Cannot get tokens'})
//                 }    
//             } else {
//                 callback(400, {'Error': 'Missing required fields'});
//             }
